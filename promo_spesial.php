...
<head>
    ...
    <title>NERRO SUPPLY - Promo Spesial</title>
...
<div class="content">
    <div class="promo-container">
        <h1>Promo Spesial</h1>
        <p>Halaman ini akan menampilkan promo-promo spesial yang sedang berlangsung.</p>
        <div class="promo-placeholder">
            Promo sedang tidak ada.
        </div>
        <!-- buat promo kedepannya ea -->
