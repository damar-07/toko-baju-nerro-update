...
if(mysqli_num_rows($result) >0 ){
    ...
    echo "tidak ada user terdeteksi";
    exit();
}
...
if(isset($_POST['update'])){
    ...
    if(mysqli_query($host, $update_query)){
        echo "<script>alert('Data berhasil diperbarui'); window.location='profil-admin.php';</script>";
    }else{
...
<head>
    ...
    <title>Toko Baju - Edit Profil Admin</title>
...
<div class="content">
    <div class="edit-form">
        <div class="form-header">Edit Profil Admin</div>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="button-group">
                ...
                <a href="profil-admin.php" class="btn btn-secondary">Kembali</a>
            </div>
        </form>
    </div>
</div>
